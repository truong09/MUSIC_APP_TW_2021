...
import 'package:my_music_app/features/media_player/audio_player_task.dart';
...
import 'package:my_music_app/features/media_player/playing_route_cubit/playing_route_cubit.dart';
import 'package:my_music_app/features/media_player/plyer_seek_cubit/player_seek_cubit.dart';
...
class MediaPlayerCubit extends Cubit<MediaPlayerStateAbstract> {
  ...
  void addTrackAndPlay(AudioTrack track) {
  ...
  Future<void> play() async {
    ...
    if (_audioTrack == null) {
      ...
      if (_audioTrack is AudioTrack) {
        _addActionToAudioService(() => addTrackAndPlay(_audioTrack));
      } else {
  ...
  Future<void> nextTrack() async {
    if (_audioTrack is AudioTrack) {
      ...
      if (nextTrack is AudioTrack) {
        ...
        emit(MediaPlayerPlayingState(_audioTrack));
        _addActionToAudioService(() => addTrackAndPlay(nextTrack));
        SongService().updateFigure(_audioTrack.id);
      } else {
